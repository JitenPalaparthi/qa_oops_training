...
public class Program {
    public static void main(String[] args){
        ...
        area(new Rectangle(12.45f,15.67f,"Red","X:100=Y:120") );
        area(new Square(25.25f, "Blue", "X:50.50=Y:55.50") );

        perimeter(new Rectangle(12.45f,15.67f,"Red","X:100=Y:120") );
        perimeter(new Square(25.25f, "Blue", "X:50.50=Y:55.50") );

        Shape rect = new Rectangle(12.45f,15.67f,"Red","X:100=Y:120");
        area(rect);
